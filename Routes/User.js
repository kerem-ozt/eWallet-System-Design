...
UserRouter.post('/create', RolePermissionHelper.checkRole(['admin']), UserController.createUser);
...
UserRouter.delete('/delete/:id', RolePermissionHelper.checkRole(['admin']), UserController.deleteUser);
