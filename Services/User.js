...
class UserServices {
        ...
        try {
            ...
            if (!user)
                return {
                    type: false,
                    data: null,
                    message: `getUserById failed: user not found`,
                };
        ...
        try {
            ...
            if (!user)
                return {
                    type: false,
                    data: null,
                    message: `deleteUser failed: user not found`,
                };
    ...
    static async getCurrentUser(req) {
        try {
            const decodedToken = TokenHelper.decodeToken(
            ...
            if (!user)
                return {
                    type: false,
                    data: null,
                    message: `getCurrentUser failed: user not found`,
                };
            return {
                type: true,
                data: user,
